...
alert("Code taken from https://codepen.io/MohammadDiab/pen/JLMvEY");
alert(
  "Just design changed by me and extra Code added to check row and column wise duplicate value !"
);
alert(
  "Enjoy this game and write in comment box if there is any problem and also how much time taken to complete this game !"
);
    ...
    for (var j = 0; j < 9; j++) {
      ...
      input.onchange = function () {
        ...
        function checkInput(input) {
          //alert(input.parentNode.parentNode.rowIndex)
          ...
          if (
            checkRow(
              "",
              input.parentNode.parentNode.rowIndex,
              input.parentNode.cellIndex,
              input.value[0]
            )
          ) {
            input.value = "";
            ...
            input.value = "";
            input.focus();
          } /*else if(!check3x3Square("", input.parentNode.cellIndex, input.parentNode.parentNode.rowIndex, input.value[0])) {
                        input.value = "";
                        input.focus();
                    }*/
        }
        ...
        function checkRow(board, row, column, value) {
          // Iterate through every value in the row
          for (var m = 0; m < 9; m++) {
            // If a match is found, return true
            var input1 =
              table.rows[row].cells[m].getElementsByTagName("input")[0];

            if (column != m && input1.value[0] === value) {
              return true;
            }
          }
        ...
        function checkColumn(board, row, column, value) {
          // Iterate through each value in the column
          for (var n = 0; n < 9; n++) {
            var input1 =
              table.rows[n].cells[column].getElementsByTagName("input")[0];

            // If a match is found, return true
            if (n != row && input1.value[0] === value) {
              return true;
            }
          }
          // If no match was found, return false
        ...
        function check3x3Square(board, column, row, value) {
          ...
          for (var k = rowCorner; k < rowCorner + squareSize; k++) {
            // Iterate through each column
            for (var l = columnCorner; l < columnCorner + squareSize; l++) {
              var input1 =
                table.rows[k].cells[l].getElementsByTagName("input")[0];

              // Return true is a match is found
              if (input1.value[0] === value) {
                return true;
              }
            }
          }
